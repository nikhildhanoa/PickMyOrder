...
.form-horizontal .form-group {
    ...
    <script src="https://cdn.tiny.cloud/1/0c36eovb48r8hmfnmkrmms2l2hbyy5a05hq5pxvzrz87luqh/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<div class="container">
...
<div id="menu1" class="tab-pane active">
   <div class="container">
      <ul class="nav nav-tabs">
		 ...
		 <!-- <li class="<?php if($open_tab=='pdf'){ ?>active<?php } ?>"><a data-toggle="tab" href="#vs">Van Stock</a></li>-->
                              ...
                              <div class="form-horizontal">
                                 ...
                                 <div class="form-group ">
                                    <label>Description</label>
                                       ...
                                       <textarea  id="single_decsription"  name="Description" class="form-control form-control-solid newtextarea"><?php echo $Single_Product['description']; ?>
									   </textarea
>                                   
                                 </div>
                                 <!--<div class="form-group ">
                                 ...
                                 <div class="form-group">
                                    <label>VAT Deductable</label>
                                       ...
                                       No<input type="radio"  value="0" <?php if($Single_Product['vat_deductable']!=1){?>checked <?php } ?> name="deduct" class="tax_class">
                                    ...
                                    <div id="tax_class">
                                       <select name="tax" id="taxrate" class="form-control form-control-solid">
                                          <option value='' selected disabled>--Selected--</option>
										   <option value='0' <?php if($Single_Product['tax_class']=='0'){ ?> selected <?php } ?>>0%</option>
						                ...
						                <!----------------Tax ------------------------->  
							<!--<div class="form-group">
								  <label>Add To Van-Stock</label>
									  <input <?php if($Single_Product['van_stock']=='1') { ?> checked <?php } ?>   type="checkbox"  name="invan" class="method" id="vanstock" >
								  </div>
								  <div id="isVan" style="display:none" class="Isvan">
								  <label>Stock Level</label>
								  <input type="text" name="stocklevel" value="<?php echo $Single_Product['stocklevel']; ?>"class="form-control vanlevel" > 
								  <label>Reorder Level</label>
								  <input type="text" name="reorderlevel" value="<?php echo $Single_Product['recordlevel']; ?>" class="form-control vanlevel" >
								  </div>
								  ...
								  <input type="number" name="InStock" value="<?php echo $Single_Product['in_stock']; ?>" class="form-control form-control-solid" >
								   </div>-->
                                 ...
                                 <div class="form-group">
                                    <label>Publish Status</label>
									   ...
									   <?php if(isset($_REQUEST['error']) && $_REQUEST['error']=='van'){?>
										   
										   <h3 class=" font-size-lg text-dark font-weight-bold mb-6" style="padding: 16px 0 16px 0px !important;color:red !important">Van product cannot published without choosing a supplier </h3>
					 ...
					 <?php 
					 $sub_Sub_Sub_Category_id=$Single_Product['super_sub_sub_cat_id'];
					 
					 $AllSupersubSubCat=$this->db->query("select * from dev_super_sub_sub_cat   where id='$sub_Sub_Sub_Category_id'");
					 //print_r($this->db->last_query());die;
                        $AllSupersubSubCat=$AllSupersubSubCat->result_array();
                        ?>
					 <div class="form-group">
                     <label>sub_Sub_Sub_Category</label>
                    
                     <select class="form-control form-control-solid"  name="sub_Sub_Sub_Category" id="subsubsubcat">
                     <option value='0'>-------------Select-----------------</option>
                     <?php foreach($AllSupersubSubCat as $Allsubsub){ ?>
                     <option <?php if( $Allsubsub['id']==$Single_Product['super_sub_sub_cat_id']){ $selectedid=$all['id'];?> selected <?php } ?> value="<?php echo $Allsubsub['id']; ?>"> <?php echo $Allsubsub['name'];?></option>
                     <?php } ?>
                     </select>
               ...
               <div class="row">
                  <form id="productimageform" method="post" enctype="multipart/form-data">
                     ...
                     <?php
						...
						if(isset($Single_Product['product_image_three']))
                        {
                        	if($Single_Product['product_image_three']!='')
                        {
                        $str2=$Single_Product['product_image_three'];
                        $str2=explode("/",$str2);
						...
						// resize product image one  
						$Firstimage = $Single_Product['products_images']; 
						if($Single_Product['products_images']!=='')
						{	
						 list($width, $height) = getimagesize($Firstimage);
						  ...
						  // resize product image rwo  
						  
						  if($Single_Product['products_images']!=='')
						{
							if($Single_Product['product_image_two']!='')
							{	
							  $Secondimage = $Single_Product['product_image_two']; 
							 list($second_width, $Second_height) = getimagesize($Secondimage);
							  
							  if($Second_height>$second_width && $Second_height>150 )
							  {
								 
								 $second_width =($second_width*100)/$Second_height;
								 $Second_height=150;
								 
								  
							  }
							  elseif($second_width>$Second_height && $second_width>150)
							  {
								   $Second_height =($Second_height*100)/$second_width;
								   $second_width=150;
							  }
						    }
						}	
                     ...
                     <div class="col-md-12">
                        <div class="row">
                           <div class="col-sm-6">
                              ...
                              <img style="image-rendering: crisp-edges;" src="<?php echo $Single_Product['products_images'] ?>" id="profile-img-tag" height="<?php echo $height?>" /> <span id="products_images"><i <?php if($Single_Product['products_images']!=''){ ?> style="display:block" <? } else{ ?>  style="display:none" <?php } ?> id="imagenone1" class="removeimage fa fa-times-circle " aria-hidden="true"></i></span>
                           </div>
                           <div class="col-sm-6">
                              <div  class="btn-new-sec"> <input   class="btn-3" id="img_2" type="file" name="product_image_2" >
                                 <img src="<?php echo $Single_Product['product_image_two'] ?>" id="profile-img-tag2" height="<?php echo  $Second_height ?>" /> <span id="product_image_two"><i <?php if($Single_Product['product_image_two']!=''){?> style="display:block" <? } else{ ?> style="display:none" <?php } ?> id="imagenone2" class="removeimage fa fa-times-circle " aria-hidden="true"></i></span>
                                 <input type="hidden" value="<?php echo $Single_Product['id'];?>" name="product_id_in_images"> 
                              </div>
                           </div>
						   
						  <!--   <div class="col-sm-6">
                              <div  class="btn-new-sec"> <input   class="btn-3" id="img_3" type="file" name="product_image_3" >
                                 <img src="<?php echo $Single_Product['product_image_three'] ?>" id="profile-img-tag3" width="200px" /> <span id="product_image_three"><i <?php if($Single_Product['product_image_three']!=''){?> style="display:block" <? } else{ ?> style="display:none" <?php } ?> id="imagenone3" class="removeimage fa fa-times-circle " aria-hidden="true"></i></span>
                                 <input type="hidden" value="<?php echo $Single_Product['id'];?>" name="product_id_in_images"> 
                              </div>
                           </div>
						 <div class="col-sm-6">
                              <div  class="btn-new-sec"> <input   class="btn-3" id="img_4" type="file" name="product_image_4" >
                                 <img src="<?php echo $Single_Product['product_image_four'] ?>" id="profile-img-tag2" width="200px" /> <span id="product_image_four"><i <?php if($Single_Product['product_image_four']!=''){?> style="display:block" <? } else{ ?> style="display:none" <?php } ?> id="imagenone2" class="removeimage fa fa-times-circle " aria-hidden="true"></i></span>
                                 <input type="hidden" value="<?php echo $Single_Product['id'];?>" name="product_id_in_images"> 
                              </div>
                           </div>
						   <div class="col-sm-6">
                              <div  class="btn-new-sec"> <input   class="btn-3" id="img_5" type="file" name="product_image_5" >
                                 <img src="<?php echo $Single_Product['product_image_five'] ?>" id="profile-img-tag2" width="200px" /> <span id="product_image_five"><i <?php if($Single_Product['product_image_five']!=''){?> style="display:block" <? } else{ ?> style="display:none" <?php } ?> id="imagenone2" class="removeimage fa fa-times-circle " aria-hidden="true"></i></span>
                                 <input type="hidden" value="<?php echo $Single_Product['id'];?>" name="product_id_in_images"> 
                              </div>
                           </div>-->
                           <hr>
                                 ...
                                 <div class="col-md-6 col-xs-12 " id="form">
                                    <div class="form-group">
                                       <label>Cost</label>
										  ...
										  <!---------------->
										 <?php if($Single_Product['van_stock']=='1'){?>
										 

										<input type="radio"  id="cost" name="suppliercost" value="supp<?php echo $i;?>"  class="free" style="float: right;position: relative; top: -30px; left: 25px;"> 
                                       <?php }?>											
                                     
									 <!---------------->
                                    </div>
                                 </div>
                                  <i id="<?php echo "supcost".$i; ?>" class="fa fa-times-circle removesupcost" aria-hidden="true" style="position: relative;
    top: -103px;
    left: 72px;"></i>
                              </div>
                           </div>
               ...
               <div class="row">
                  ...
                  <div class="form-horizontal" id="addnewsp">
                     ...
                     <div class="form-group spc<?php echo $j;?> " >
                        <div class="col-md-12  ">
                           <textarea id="singlespc"  rows="4"  name="spc<?php echo $j;?>"  class="form-control newtextarea" placeholder="Description" ><?php echo $Single_Product['specification'];?></textarea>
		 ...
		 $products_van=$this->db->query("select * from products_van where product_id='$Product_Edit_Id'");
		...
		$van_id= $products_van[0]['van_id'];
		 ...
		 <div id="vs" class="tab-pane <?php if($open_tab=='pdf'){ ?>active<?php } ?>">
		 <div id="van_idapp">
		 <div class="form-group">
                     ...
                     <select class="form-control form-control-solid"  name="" id="van" style="width: 50%;">
                     <option value='0'>-------------Select-----------------</option>
                     <?php foreach($vanlist as $Allvanlist){ ?>
                     <option       value="<?php   echo $Allvanlist['id']; ?>">  <?php   echo $Allvanlist['driver_name'];  ?> </option>
                     <?php } ?>
                     </select>
					 ...
					 <div class="form-group" style="margin-top:20px;">
		                ...
		                <div class="col-md-12 marg_1">
                           ...
                           <label>
                           <span  id="vanupdate" class="btn btn-info" >UPDATE</span>
                           </label> 
                        </div>
...
$('#add_van1').click(function(){
	...
	var InStock=$('#InStock').val();
        ...
        $.ajax({
				...
				url:"<?= base_url('')?>AddVanStock",
				method:"post",
				data:{'vans':van,'stocklevels':stocklevel,'reorderlevels':reorderlevel,'InStocks':InStock,'prdid':<?php  echo $Single_Product['id']; ?>},
		 ...
		 /*************************vanstock**********************************/
					jQuery('.method').click(function()                           // change on dedicate 
					{
						if(jQuery('#vanstock').prop('checked') == true)
						{
							jQuery('#isVan').css('display','block');
							$(".vanlevel").prop('required',true);
							$(".vanlevel").prop('required',true);
							 
						}
						
						if(jQuery('#vanstock').prop('checked') == false)
						{
							jQuery('#isVan').css('display','none');
							$(".vanlevel").prop('required',false);
							$(".vanlevel").prop('required',false);
...
/***************************endvanstock*******************************/
   $(document).ready(function(){
    ...
    var form_data = new FormData($('#product_form')[0]);
		 the_content=tinyMCE.get('single_decsription').getContent();
		 var desc=$('#single_decsription').text(the_content);
    ...
    jQuery("#addspcibutton").click(function(){                 //Add specifications
     ...
     $.ajax({
   	...
   	/********************close add details************************/
   	/**********************productimageform*********************/
   	 $('#img_1,#img_2,#img_3').change(function(){
   	...
   	product_id=<?php echo $Product_Edit_Id; ?>;
   	 ...
   	 $.ajax({
   		...
   		success:function(data){
			...
			if(data=='product_image_three')
   			{
   				$('#imagenone3').css('display','none');
   				$('#profile-img-tag3').attr('src',"");
   			}
	...
	?>
	 ...
	 /*************************************/
	 	...
	 	$('#subsubcat').change(function(){
				$sub_sub_cat_id=$(this).val();
				$.ajax({
				url:"<?= base_url('')?>getsupersubsubcatbyajax",
				method:"GET",
				data:{'sub_sub_cat_id':$sub_sub_cat_id},
				success:function(data){
					  $('#subsubsubcat').empty();
					  $('#subsubsubcat').append('<option value="" selected >--Select--</option>'); 
					...
					$('#subsubsubcat').append('<option value="'+data[i].id+'" selected="selected">'+data[i].name+'</option>'); 
					}  
   ...
   $.ajax({
   		...
   		success:function(data){
   			...
   			for(i=0;i<objlen;i++)
   			{
   				...
   				plaseholder=decodeddata[i].plaseholder	;
   			    product_id=decodeddata[i].product_id;
   			$('table#Variation_row tbody').after("<tr class="+id+"ro><td>+</td><td>"+name+"</td><td>"+plaseholder+"</td><td><a href=variationpage?optionid="+id+"&&product="+product_id+">view</a></td><td><a href=variationpage?optionid="+id+"&&product="+product_id+"> <i id="+id+" class='variationupdate fa fa-edit' aria-hidden='true'></i></a></td><td><i id="+id+" class='delvarrow fa fa-times-circle ' aria-hidden='true'></i></td></tr>");
...
<script type="application/x-javascript">
   tinymce.init({selector:'.newtextarea'});
