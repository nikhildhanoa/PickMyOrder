	...
	{	
		...
		padding-top: 10px;">'.$procode_new.'</td>
		     ...
		     /**********************Send order details in M8 service************************/
			  ...
			  $query= $this->db->query("select uuid,invioce_Order_Number from dev_projects where id='$project_id'"); 
		...
		$get_logo=$this->db->query("select bussiness_logo from dev_business where id='$Busines_id'");
				  ...
				  <li>'.$get_bussiness_details1[0]['city'].'</li>
						...
						<ul style="list-style:none; padding-left:0px;">
						  <li style="padding-bottom: 5px;"><b>Purchase Order Date</b></li>
						   ...
						   <li style="padding-bottom: 5px;">'.$invioce_Order_Number.'</li>
