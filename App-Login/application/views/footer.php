		...
		<script src="NewThemeAssets/assets/plugins/custom/draggable/draggable.bundle.js"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="NewThemeAssets/assets/js/pages/features/cards/draggable.js"></script>
		<script src="NewThemeAssets/assets/js/pages/features/ktdatatable/base/data-json.js"></script>
		        
    <script src="NewThemeAssets/dropzone/dist/dropzone.js"></script>
	<script src="NewThemeAssets/CustomDrag.js"></script>   
	<script src="NewThemeAssets/scriptCreation.js"></script>  
<!--begin::Global Theme Bundle(used by all pages)-->
		<script src="NewThemeAssets/assets/plugins/global/plugins.bundle.js"></script>
		<script src="NewThemeAssets/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
		<script src="NewThemeAssets/assets/js/scripts.bundle.js"></script>	
		<script src="NewThemeAssets/assets/js/pages/widgets.js"></script>
		<!--end::Page Scripts-->
		<!-- end::Demo Panel -->
