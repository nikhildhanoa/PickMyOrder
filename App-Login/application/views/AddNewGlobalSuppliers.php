...
<div class="card-header">
 ...
 <div class="jumbotron-sec marg ">
  ...
  <form method="post"  enctype="multipart/form-data" action="<?php echo site_url('AddNewSingleGlobalSupplier');?>"  >
   <div class="form-horizontal">
 <!----------------busniss-name------------------------->   
   <div class="form-group">
      ...
      <input required type="text" class="form-control form-control-solid" placeholder="Enter Name" name="SupplierName">
 ...
 <label >Supplier logo</label>
      ...
      <input required type="file" class="form-control form-control-solid"   name="Supplierlogo">
