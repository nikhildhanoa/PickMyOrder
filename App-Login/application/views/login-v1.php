	...
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-column-fluid bg-white position-relative overflow-hidden" id="kt_login">
				<!--begin::Header-->
				<div class="login-header py-10 flex-column-auto" style="background-color: #14499A;">
					<div class="container d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between">
						...
						<img src="https://app.pickmyorder.co.uk/images/applogo/Back_End_Logo_2.png" alt="logo" width="170px"/>
						...
						<a href="<?php echo base_url('AccountCreateForTrial'); ?>" id="kt_login_signup" class="text-primary font-weight-bolder" style="color:#fff!important">Create an Account</a></span>
						
					</div>
				</div>
				<!--end::Header-->
				<!--begin::Body-->
				<div class="login-body d-flex flex-column-fluid align-items-stretch justify-content-center" style="background-color: #14499A;">
					<div class="container row">
						<div class="col-lg-6 d-flex align-items-center">
							<!--begin::Signin-->
							<div class="login-form login-signin">
								<!--begin::Form-->
								<form method="post"  style="background-color:#fff" action="<?php echo base_url('dashboard') ?>" class="form w-xxl-550px rounded-lg p-20" novalidate="novalidate" id="kt_login_signin_form"  >
									<!--begin::Title-->
									<div class="pb-13 pt-lg-0 pt-5">
										<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to <span style="color: #21519e;font-weight:800"><img style="width:132px" src="https://app.pickmyorder.co.uk/images/applogo/Back_End_Logo_4.png"></span></h3>
										<p style="color:red;text-align:center;font-size:16px;font-weight:500"><?php echo $this->session->flashdata('Invalid'); ?></p>
									</div>
									<!--begin::Title-->
									<!--begin::Form group-->
									...
									<div class="form-group">
										<div class="d-flex justify-content-between mt-n5">
											...
											<a href="<?php echo base_url('ForgetPassword');  ?>" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot" style="color:#14499a!important;">Forgot Password ?</a>
										</div>
									...
									<div class="pb-lg-0 pb-5">
										<input type="submit"  name="login"  value="Login" id="kt_login_signin_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" style="display:block;width: 100%;background: #14499a;">
				...
				<!--end::Body-->
				<!--begin::Footer-->
				<div class="login-footer py-10 flex-column-auto" style="background-color: #14499A;">
					<div class="container d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between">
						<div class="font-size-h6 font-weight-bolder order-2 order-md-1 py-2 py-md-0">
							...
							<a href="https://app.pickmyorder.co.uk/index" target="_blank" class="text-dark-50 text-hover-primary">TradesM8</a>
						</div>
						<div class="font-size-h5 font-weight-bolder order-1 order-md-2 py-2 py-md-0">
							<a href="#" class="text-primary" style="color:#fff!important">Terms</a>
							<a href="#" class="text-primary ml-10" style="color:#fff!important" >Plans</a>
							<a href="#" class="text-primary ml-10" style="color:#fff!important">Contact Us</a>
						</div>
					</div>
				</div>
				<!--end::Footer-->
