...
$bussidata=$this->db->query("select business_name,Trial_business,CategoryList,iswholeapp,invoice_management_premission from dev_business where id='$bid'");

$namedata=$bussidata->result_array();

$bname=$namedata[0]['business_name'];   
$Trial_business_status=$namedata[0]['Trial_business'];
$CategoryList=$namedata[0]['CategoryList'];
$BusinessType=$namedata[0]['iswholeapp'];
$invoice_management_premission=$namedata[0]['invoice_management_premission'];
...
<!--begin::Aside-->
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">  
						<!--begin::Logo-->
						<a href="<?php echo base_url('dashboard'); ?>" class="brand-logo" style="position: relative;left: -7px;">
							<img alt="Logo" src="<?php echo base_url(); ?>/images/applogo/Back_End_Logo_4.png" class="h-30px" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<?php 	if(isset($_SESSION['status'])){
								$userid=$_SESSION['status']['user_id'];
									...
									$permissionsForBusiness=$this->DataModel->permissionsForBusiness($bid);
					...
					?>
								...
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item" aria-haspopup="true">
									<a  href="<?php echo site_url("TrialBusiness");?>" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Home/Library.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text"> Trial Business</span>
									</a>
								</li>
					...
					<!--------------------------------------------------------->
									<?php if($permissions['permission_super_Admin']=='1' && $bid!='15'){	?>
									<li class="menu-item " aria-haspopup="true"  >
									<a href="<?php echo site_url('Advertisment'); ?>" class="menu-link ">
										<span class="svg-icon menu-icon">
										...
										<span class="menu-text">Advertisment  </span>
					...
					<!--------------------------------------------------------->
								...
								<!--------------------for business_id 15 only---------------------->
								<li style="display:<?php if($bid=='15'){ echo "block" ;}else{ echo "none";} ?>" class="menu-section">
							...
							<?php if($role=='1' && $BusinessType=='0') { ?>
								
								<?php if($permissions['permission_super_Admin']=='1'|| $permissions['permission_products']=='1'){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url('LukinsFailureProducts');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Lukins Failure Products</span>
							...
							<?php if($permissions['permission_super_Admin']=='1'|| $permissions['permission_ElectricalCatalogue']=='1'){	?>
								<li class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url('GetLukinsProducts');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Electrical Catalogue</span>
							...
							<!----------------------------------------------------------------------->
								...
								<!---------------------------------------------------->
								<li class="menu-item " aria-haspopup="true" style="display:<?php echo $OnlyProductApp; ?>" >
									<a href="<?php echo site_url('CategoryList'); ?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Files/Pictures1.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<!--  comment dropdown -->
								<?php if($permissions['permission_super_Admin']=='1' ||  $invoice_management_premission=='1'){	?>
						<li  id="sidebar_invoce_management_id"    class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle" id="sidebar_invoce_management_id2" >
										<span class="svg-icon menu-icon">
										...
										<span class="menu-text">Invoices Managment </span>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php base_url()?>/Invoice" class="menu-link">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php base_url()?>/Quotation" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php base_url()?>/Creditnote" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php echo base_url() ?>Statement" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php base_url()?>/SetUp" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="<?php base_url()?>/productCatalogue" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
							...
							<!-- drop down -->
								 ...
								 <!---------------------------------------------------->
								<li class="menu-item " aria-haspopup="true" style="display:<?php echo $OnlyProductApp; ?>" >
									<a href="<?php echo site_url('GlobalSupliers'); ?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Files/Pictures1.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Global Suppliers</span>
							...
							<?Php } ?>
								...
								<!----------------------------Catalogues---------------------------->
								<li style="display:<?php if($bid=='15'){ echo "block" ;}else{ echo "none";} ?>" class="menu-section">
									<h4 class="menu-text">Catalogues</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>       
								</li>
								...
								<li  class="menu-item " aria-haspopup="true" >
									...
									<li class="menu-item " aria-haspopup="true" style="display: <?php if($bid=='15'){ echo "block" ;}else{ echo "none";}  ?>" >
									<a href="<?php echo site_url('TransferShelves'); ?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Files/Pictures1.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Shelves (Copy)</span>
									...
									<?php if($role=='1' && $BusinessType=='0') {?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url('integrateServiceM8');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
										...
										<span class="menu-text">integrate Service M8 </span>
								...
								<?php } ?>
									...
									<!---------------------------------------------------------------------->
									<?php if($permissions['permission_super_Admin']=='1'|| $permissions['permission_vanstock']=='1'){	?>
									<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-section">
									<h4 class="menu-text">Van stock</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>       
								</li>
								<?php } ?>
								<!--------------------------------------delivery collection------------------------------------------>
									<?php if($permissions['permission_super_Admin']=='1'|| $permissions['permission_vanstock']=='1'){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url('DeliveryCollection');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Globel Delivery/Collection </span>
								...
								<?php if($permissions['permission_super_Admin']=='1'|| $permissions['permission_vanstock']=='1'){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true"  >
									<a href="<?php echo site_url('vanstock');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Van Stock</span>
								...
								<!--<li style="display:<?php // if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true"  >
									<a href="<?php echo site_url('testing');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg--
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<?php if($permissions['permission_super_Admin']=='1'|| $permissions['permission_vanstock']=='1'){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url('Vans');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<?php if($permissions['permission_super_Admin']=='1'|| $permissions['permission_vanstock']=='1' ){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true">
									<a href="<?php echo site_url('ReorderProducts');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text"> Van Stock Reorder  </span>
								...
								<!---------------------------------------trial plan----------------------------------------
								<li style="display:<?php if($OnlyProductApp=='block'){ echo "none" ;}else{ echo "block";} ?>" class="menu-section">
									<h4 class="menu-text">Pricing</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>       
								</li> --->
								<?php if($Trial_business_status!=0) { ?> 
								<li class="menu-item " aria-haspopup="true"  >
									<a href="<?php echo site_url('paymentPackages');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text"> view plan </span>
								...
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url("Delevercost");?>" class="menu-link ">
										...
										<span class="menu-text">Delivery cost </span>
...
////  (start function)  this function work for sidebar "invoice management" tab        
	     $('#sidebar_invoce_management_id2').click(function(){
		   sessionStorage.clear();
		var className = $("#sidebar_invoce_management_id").hasClass("menu-item-open");
		...
		sessionStorage.setItem("scopeType",scope );
	  });
		let Type = sessionStorage.getItem("scopeType");
		if(Type=='open')
		{  
			var Change_class_Name1 = $("#sidebar_invoce_management_id").addClass("menu-item-open");
		}
		else
		{ 
			var Change_class_Name2 = $("#sidebar_invoce_management_id").removeClass("menu-item-open");
		}							  
		 });
		/// end function						
