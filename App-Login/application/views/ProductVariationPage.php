...
<div class="container">
 <ul class="nav nav-tabs">
	  ...
	  <li class="active"><a data-toggle="tab" style="margin-left: 23px;"  href="#ao">Variations</a></li>
  </ul>
...
<div class="col-md-12">
   ...
   <div class="form-group col-md-2 marg ">
	  ...
	  <div class="col-md-9 marg form-group ">
	...
	<div class="col-md-12 marg my-2">
	
   <input  type="submit" class="btn btn-primary" id="Add_Variations" name="Add_Variations" value="Add Variations">
	<div>
    </div>
</div>
  </div>
 ...
 <?php if(isset($_GET['product']))
  ...
  <div class="btn-goback"><input type="SUBMIT" name="goback" value="GO BACk" class="btn btn-primary"></div>
  </div>
  <form>
   <?php }else{
	   ?>
	    <form action="<?php echo site_url('products');?>" method="post">
  <input type="SUBMIT" name="gobackproduct" value="GO BACk"  class="btn btn-primary" >
  <form>
  <?php } ?>
<hr>
</div>
	   ...
	   <div class="row">
	    <table class="table">
		  ...
		  <tr >
			  ...
			  <td id="<?php echo $single['id'];?>"><span class="editsinglevariation"><i class="fa fa-edit" aria-hidden="true"></i></span></td>
			  <?php $id=$single['id']; ?>
