	...
	{   
		...
		{     // print_r($_SESSION);die;
			if(isset($_SESSION['status']))
			{
				...
				$data=array('numberOfEngineer'=>$NOI,'numberOfSupplier'=>$NOs,'numberOfOrder'=>$All_orders->num_rows());
