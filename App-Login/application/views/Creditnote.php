...
<div><div class="container">
								...
								<div class="card card-custom">
									...
									<h5 class="text-dark font-weight-bold my-1 mr-5">Credit Notes</h5>
									<!-- card tabs
									<div class="new_tabs_invoices" style="width:100%;padding-bottom:2em;">
<div class="container" style="padding:0px">
    <div class="row">
	     <div class="new_tabs_invoices_col" style="flex:1"> <a href="<?php base_url()?>/Invoice" class="new_tabs_anchor"  style="padding: 1rem;border: none;background: #242939;;width: 100%;display: block;text-align: center;color: #fff;font-size: 17px;">Invoices</a></div>
	     ...
	     <div class="new_tabs_invoices_col" style="flex:1"> <a href="<?php base_url()?>/Creditnote" class="new_tabs_anchor"  style="padding: 1rem;border: none;background: #134798;width: 100%;display: block;text-align: center;color: #fff;font-size: 17px;">Credit notes</a></div>
