...
$Cat_Cute_Name=$data_array[0]['Cat_Cute_Name'];
				...
				<form  method="post" enctype="multipart/form-data" action="<?php echo site_url('changeCatNewTheme'); ?>">
						  ...
						  <div class="jumbotron-sec marg ">
							 ...
							 <div class="form-group ">
								...
								<?php if($bid=='15') { ?>
								<input type="text" class="form-control form-control-solid" value="<?php echo $cat_name; ?>"  name="cat_name">
								<?php   } else { ?>
                            <input type="text" class="form-control form-control-solid" value="<?php echo $cat_name; ?>"  name="cat_name" readonly>
							
							<input type="hidden" value="<?php echo $Cat_Cute_Name; ?>" name="Cat_Cute_Name" > 
                                <?php } ?>								
							 ...
							 <div class="form-group ">
								  <label>Name In App</label>
										...
										<input type="text" class="form-control form-control-solid" value="<?php echo $Cat_Cute_Name; ?>"  name="Cat_Cute_Name">
