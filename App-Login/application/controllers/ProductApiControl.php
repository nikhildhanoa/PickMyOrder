...
class ProductApiControl extends CI_Controller {
	...
	public function  GetVanCat()
	{
		$this->load->view('api/GetVanCat');
	}
	public function  GetVanSubCat()
	{
		$this->load->view('api/GetVanSubCat');
	}
	
	public function  GetProductSuperSubSubCategory()
	{
		$this->load->view('api/GetProductSuperSubSubCategory');
	}
