...
var KTWidgets = function() {
    ...
    // Stats widgets
    var _initStatsWidget2 = function(number) {  
  ...
  // Stats widgets
    var _initChartsWidget5 = function(num) {
    ...
    var _initChartsWidget3 = function(numer) {
  ...
  var fat=[];
		...
		$.ajax({
		url:"https://stagingapp.pickmyorder.co.uk/GetNumberEngineers",
		success:function(data1){
			var val=JSON.parse(data1);
			
			var name=JSON.stringify(val.name);
			var numer=JSON.stringify(val.num);
			
		_initStatsWidget2(numer);
		
		}
	  });
	  
		  $.ajax({
			url:"https://stagingapp.pickmyorder.co.uk/GetNumberSupplier",
			success:function(data1){
				var val=JSON.parse(data1);
				var numer=JSON.stringify(val.num);
				_initChartsWidget5(numer);
