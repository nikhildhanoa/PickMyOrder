			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('themeCustomization/NewThemeAssets/assets/media/users/150-6.jpg')"></div>
							...
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<span class="svg-icon svg-icon-md svg-icon-primary">
										<!--begin::Svg Icon | path:themeCustomization/NewThemeAssets/assets/media/svg/icons/General/Half-star.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
									<span class="svg-icon svg-icon-md svg-icon-info">
										<!--begin::Svg Icon | path:themeCustomization/NewThemeAssets/assets/media/svg/icons/Communication/Mail-opened.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24" />
					...
					<div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
						...
						<div class="d-flex flex-center position-relative ml-4 mr-6 ml-lg-6 mr-lg-10">
							<span class="svg-icon svg-icon-4x svg-icon-primary position-absolute opacity-15">
								<!--begin::Svg Icon | path:themeCustomization/NewThemeAssets/assets/media/svg/icons/Layout/Layout-polygon.svg-->
							...
							<span class="svg-icon svg-icon-lg svg-icon-primary position-absolute">
								<!--begin::Svg Icon | path:themeCustomization/NewThemeAssets/assets/media/svg/icons/Files/File-done.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<polygon points="0 0 24 0 24 24 0 24" />
					...
					<div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
						...
						<div class="d-flex flex-center position-relative ml-4 mr-6 ml-lg-6 mr-lg-10">
							...
							<span class="svg-icon svg-icon-lg svg-icon-danger position-absolute">
								<!--begin::Svg Icon | path:themeCustomization/NewThemeAssets/assets/media/svg/icons/Design/PenAndRuller.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
					...
					<div class="bg-gray-100 d-flex align-items-center p-5 rounded gutter-b">
						...
						<div class="d-flex flex-center position-relative ml-4 mr-6 ml-lg-6 mr-lg-10">
							...
							<span class="svg-icon svg-icon-lg svg-icon-info position-absolute">
								<!--begin::Svg Icon | path:themeCustomization/NewThemeAssets/assets/media/svg/icons/Home/Alarm-clock.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
		...
		<script src="themeCustomization/NewThemeAssets/assets/plugins/global/plugins.bundle.js"></script>
		<script src="themeCustomization/NewThemeAssets/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
		<script src="themeCustomization/NewThemeAssets/assets/js/scripts.bundle.js"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="themeCustomization/NewThemeAssets/assets/plugins/custom/draggable/draggable.bundle.js"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="themeCustomization/NewThemeAssets/assets/js/pages/features/cards/draggable.js"></script>
		<script src="themeCustomization/NewThemeAssets/assets/js/pages/features/ktdatatable/base/data-json.js"></script>
		        
    <script src="themeCustomization/NewThemeAssets/dropzone/dist/dropzone.js"></script>
	<script src="themeCustomization/NewThemeAssets/CustomDrag.js"></script>   
	<script src="themeCustomization/NewThemeAssets/scriptCreation.js"></script>   
		<!--end::Page Scripts-->
		<!-- end::Demo Panel -->
