...
<!--begin::Aside-->
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<?php } ?>
								...
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item  menu-item-open menu-item-here" aria-haspopup="true" >
									<a href="<?php echo site_url('quotes');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Layout/Layout-arrange.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
								...
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url("suppliers");?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Devices/Diagnostics.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
								...
								<?php if($permissions['permission_super_Admin']=='1' && $this->DataModel->CheckBussinessStatus()!=1|| $permissions['permission_suppliers']=='1'){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url("invoiceView");?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/General/Attachment2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
													<path d="M11.7573593,15.2426407 L8.75735931,15.2426407 C8.20507456,15.2426407 7.75735931,15.6903559 7.75735931,16.2426407 C7.75735931,16.7949254 8.20507456,17.2426407 8.75735931,17.2426407 L11.7573593,17.2426407 L11.7573593,18.2426407 C11.7573593,19.3472102 10.8619288,20.2426407 9.75735931,20.2426407 L5.75735931,20.2426407 C4.65278981,20.2426407 3.75735931,19.3472102 3.75735931,18.2426407 L3.75735931,14.2426407 C3.75735931,13.1380712 4.65278981,12.2426407 5.75735931,12.2426407 L9.75735931,12.2426407 C10.8619288,12.2426407 11.7573593,13.1380712 11.7573593,14.2426407 L11.7573593,15.2426407 Z" fill="#000000" opacity="0.3" transform="translate(7.757359, 16.242641) rotate(-45.000000) translate(-7.757359, -16.242641)" />
								...
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php if($type=="Engineers"){echo site_url("engineer"); }else{
												echo site_url("wholesaler"); 
											}?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Design/Select.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
										...
										<span class="menu-text"><?php if($type=="Engineers"){echo "Engineers"; }else{
												echo "Users"; 
											}?> </span>
								...
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url('projects');?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Media/Equalizer.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
								...
								<?php } ?>
								<?php if($permissions['permission_super_Admin']=='1' && $this->DataModel->CheckBussinessStatus()!=1|| $permissions['permission_catologes']=='1'){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url('newCetalogues') ?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Home/Book-open.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
										...
										<span class="menu-text">Catalogues</span>
								...
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url("Delevercost");?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Home/Mirror.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24" />
													<path d="M11.7573593,15.2426407 L8.75735931,15.2426407 C8.20507456,15.2426407 7.75735931,15.6903559 7.75735931,16.2426407 C7.75735931,16.7949254 8.20507456,17.2426407 8.75735931,17.2426407 L11.7573593,17.2426407 L11.7573593,18.2426407 C11.7573593,19.3472102 10.8619288,20.2426407 9.75735931,20.2426407 L5.75735931,20.2426407 C4.65278981,20.2426407 3.75735931,19.3472102 3.75735931,18.2426407 L3.75735931,14.2426407 C3.75735931,13.1380712 4.65278981,12.2426407 5.75735931,12.2426407 L9.75735931,12.2426407 C10.8619288,12.2426407 11.7573593,13.1380712 11.7573593,14.2426407 L11.7573593,15.2426407 Z" fill="#000000" opacity="0.3" transform="translate(7.757359, 16.242641) rotate(-45.000000) translate(-7.757359, -16.242641)" />
										...
										<span class="menu-text">Delevery Cost</span>
								...
								<?php if($permissions['permission_super_Admin']=='1' && $this->DataModel->CheckBussinessStatus()==1||$permissions['permission_store']=='1'){	?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="<?php echo site_url("fillter");?>" class="menu-link ">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:new/assets/media/svg/icons/Home/Mirror.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Fillters</span>
							...
							<?php } ?>
									<?php if($_SESSION['status']['iswholseller']){ ?>
								<li style="display:<?php if($OnlyProductApp=='none'){ echo "block" ;}else{ echo "none";} ?>" class="menu-item " aria-haspopup="true" >
									<a href="javascript:;" class="menu-link ">
										...
										<span class="menu-text">Strip Connect</span>
